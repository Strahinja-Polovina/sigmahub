...
func TestRenderS3FansIntoContainerOps(t *testing.T) {
	ops, _ := renderOps("srv_t", s3Specs(), nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, nil, s3Targets(), nil, nil, ACMEConfig{})
...
func TestRenderS3SeaweedFS(t *testing.T) {
	ops, _ := renderOps("srv_t", s3Specs(), nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, nil, seaweedTargets(), nil, nil, ACMEConfig{})
