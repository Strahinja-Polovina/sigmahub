...
func TestRenderBackupOpsOrderingAndSecretFreedom(t *testing.T) {
	...
	ops, _ := renderOps("srv_t", dbSpecs("postgres"), nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, dbTargets("postgres", "database"), nil, runs, nil, ACMEConfig{}, clusterRender{})
...
func TestRenderBackupVerifyHeldUntilBackupSha(t *testing.T) {
	...
	ops, _ := renderOps("srv_t", dbSpecs("postgres"), nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, dbTargets("postgres", "database"), nil, held, nil, ACMEConfig{}, clusterRender{})
	...
	ops2, _ := renderOps("srv_t", dbSpecs("postgres"), nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, dbTargets("postgres", "database"), nil, ready, nil, ACMEConfig{}, clusterRender{})
...
func TestRenderRestorePITROpCarriesTargetTime(t *testing.T) {
	...
	ops, _ := renderOps("srv_t", nil, nil, nil,
		store.HostHardening{MeshIP: "10.8.0.5"}, nil, nil, nil, nil, runs, nil, ACMEConfig{}, clusterRender{})
